 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,$){var z=N.length;N.push($);e:for(;0<z;){var de=z-1>>>1,Ae=N[de];if(0<i(Ae,$))N[de]=$,N[z]=Ae,z=de;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var $=N[0],z=N.pop();if(z!==$){N[0]=z;e:for(var de=0,Ae=N.length,zo=Ae>>>1;de<zo;){var cr=2*(de+1)-1,Uu=N[cr],hr=cr+1,Ho=N[hr];if(0>i(Uu,z))hr<Ae&&0>i(Ho,Uu)?(N[de]=Ho,N[hr]=z,de=hr):(N[de]=Uu,N[cr]=z,de=cr);else if(hr<Ae&&0>i(Ho,z))N[de]=Ho,N[hr]=z,de=hr;else break e}}return $}function i(N,$){var z=N.sortIndex-$.sortIndex;return z!==0?z:N.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,g=!1,_=!1,v=!1,T=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(N){for(var $=n(u);$!==null;){if($.callback===null)r(u);else if($.startTime<=N)r(u),$.sortIndex=$.expirationTime,e(l,$);else break;$=n(u)}}function w(N){if(v=!1,y(N),!_)if(n(l)!==null)_=!0,Mu(A);else{var $=n(u);$!==null&&bu(w,$.startTime-N)}}function A(N,$){_=!1,v&&(v=!1,m(D),D=-1),g=!0;var z=d;try{for(y($),h=n(l);h!==null&&(!(h.expirationTime>$)||N&&!xt());){var de=h.callback;if(typeof de=="function"){h.callback=null,d=h.priorityLevel;var Ae=de(h.expirationTime<=$);$=t.unstable_now(),typeof Ae=="function"?h.callback=Ae:h===n(l)&&r(l),y($)}else r(l);h=n(l)}if(h!==null)var zo=!0;else{var cr=n(u);cr!==null&&bu(w,cr.startTime-$),zo=!1}return zo}finally{h=null,d=z,g=!1}}var C=!1,k=null,D=-1,Y=5,B=-1;function xt(){return!(t.unstable_now()-B<Y)}function Gi(){if(k!==null){var N=t.unstable_now();B=N;var $=!0;try{$=k(!0,N)}finally{$?Qi():(C=!1,k=null)}}else C=!1}var Qi;if(typeof p=="function")Qi=function(){p(Gi)};else if(typeof MessageChannel<"u"){var Sp=new MessageChannel,qw=Sp.port2;Sp.port1.onmessage=Gi,Qi=function(){qw.postMessage(null)}}else Qi=function(){T(Gi,0)};function Mu(N){k=N,C||(C=!0,Qi())}function bu(N,$){D=T(function(){N(t.unstable_now())},$)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){_||g||(_=!0,Mu(A))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Y=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(d){case 1:case 2:case 3:var $=3;break;default:$=d}var z=d;d=$;try{return N()}finally{d=z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,$){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var z=d;d=N;try{return $()}finally{d=z}},t.unstable_scheduleCallback=function(N,$,z){var de=t.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?de+z:de):z=de,N){case 1:var Ae=-1;break;case 2:Ae=250;break;case 5:Ae=1073741823;break;case 4:Ae=1e4;break;default:Ae=5e3}return Ae=z+Ae,N={id:c++,callback:$,priorityLevel:N,startTime:z,expirationTime:Ae,sortIndex:-1},z>de?(N.sortIndex=z,e(u,N),n(l)===null&&N===n(u)&&(v?(m(D),D=-1):v=!0,bu(w,z-de))):(N.sortIndex=Ae,e(l,N),_||g||(_=!0,Mu(A))),N},t.unstable_shouldYield=xt,t.unstable_wrapCallback=function(N){var $=d;return function(){var z=d;d=$;try{return N.apply(this,arguments)}finally{d=z}}}})(Iy);Ty.exports=Iy;var mE=Ty.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pu{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new x(E.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Le(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
